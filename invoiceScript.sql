...
insert into CustomerTypes(description) values ('LEAL');
insert into CustomerTypes(description) values ('VISITA');
SET IDENTITY_INSERT Customers OFF;
insert into Customers values('Maria', 'Santo Domingo', 1,2);
insert into Customers values('Jose', 'Santiago', 2,1);
insert into Customers values('Manuel', 'Nagua', 2,1);
insert into Customers values('Pedro', 'San Juan', 1,1);
insert into Customers values('Amir', 'Bani', 2,2);
insert into Customers values('Kimberly', 'La Romana', 1,2);
